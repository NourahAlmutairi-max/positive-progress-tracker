  ...
  head: () => ({
    meta: [
      { title: "Checkout | TECH PREMIUM" },
      {
        name: "description",
        content:
          "Enter your contact and shipping details to complete your TECH PREMIUM order in KD.",
      },
      {
        property: "og:title",
        content: "Checkout | TECH PREMIUM",
      },
      {
        property: "og:description",
        content: "Complete your TECH PREMIUM order securely.",
      },
    ],
  }),
  component: Checkout,
...
function Checkout() {
  const { cart, productOf, subtotal } = useStore();
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <button
              ...
              className="inline-flex h-11 min-w-48 flex-1 items-center justify-center gap-2 rounded-md bg-primary px-6 text-sm font-semibold text-primary-foreground transition hover:bg-primary/90 disabled:cursor-not-allowed disabled:opacity-60"
            >
